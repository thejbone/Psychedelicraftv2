...
//        }
    ...
    public void toggleRiftJarOpen()
    {
        if (!worldObj.isRemote)
        {
            ...
            markDirty();
            IvNetworkHelperServer.sendTileEntityUpdatePacket(this, "isOpening", Psychedelicraftv2.network);
        }
    }
    ...
    public void toggleSuckingRifts()
    {
        if (!worldObj.isRemote)
        {
            ...
            markDirty();
            IvNetworkHelperServer.sendTileEntityUpdatePacket(this, "suckingRifts", Psychedelicraftv2.network);
        }
    }

...
public class BlockCocaPlant extends Block implements IGrowable, IvTilledFieldPlant
{
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        icons[0] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "cocaPlant1");
        icons[1] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "cocaPlant2");
        icons[2] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "cocaPlant3");
    }

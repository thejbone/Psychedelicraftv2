...
public class BlockWineGrapeLattice extends Block implements IGrowable
{
    ...
    {
        return Psychedelicraftv2.blockWineGrapeLatticeRenderType;
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        leavesIcons[0] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "grapeLeaves0");
        leavesIcons[1] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "grapeLeaves1");
        leavesIcons[2] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "grapeLeaves2");
        leavesIcons[3] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "grapeLeaves3");

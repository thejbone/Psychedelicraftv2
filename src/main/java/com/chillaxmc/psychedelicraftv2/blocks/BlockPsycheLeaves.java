...
{
    public static final String[][] field_150130_N = new String[][]{{Psychedelicraftv2.modBase + "leaves_juniper", Psychedelicraftv2.modBase + "leaves_juniperBerries"}, {Psychedelicraftv2.modBase + "leaves_juniper_opaque", Psychedelicraftv2.modBase + "leaves_juniperBerries_opaque"}};

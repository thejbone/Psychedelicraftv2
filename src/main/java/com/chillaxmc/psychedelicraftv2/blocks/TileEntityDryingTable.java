...
import com.chillaxmc.psychedelicraftv2.crafting.DryingRegistry;
import com.chillaxmc.psychedelicraftv2.gui.ContainerDryingTable;
...
public class TileEntityDryingTable extends TileEntity implements ISidedInventory, PartialUpdateHandler
{
    ...
    public void updateEntity()
    {
        ...
        if (ticksAlive % 30 == 5 && !worldObj.isRemote)
        {
            ...
            IvNetworkHelperServer.sendTileEntityUpdatePacket(this, "dryingProgress", Psychedelicraftv2.network);
        }
    ...
    public void calculateHeatRatio()
    {
        ...
        if (!worldObj.isRemote)
            IvNetworkHelperServer.sendTileEntityUpdatePacket(this, "heatRatio", Psychedelicraftv2.network);
    }

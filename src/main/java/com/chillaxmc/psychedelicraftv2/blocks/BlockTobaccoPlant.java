...
public class BlockTobaccoPlant extends Block implements IGrowable, IvTilledFieldPlant
{
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        icons[0] = blockIcon;
        icons[1] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlant1");
        icons[2] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlant2");
        icons[3] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlant3");

        icons[4] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlantTop");
        icons[5] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlant1Top");
        icons[6] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlant2Top");
        icons[7] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "tobaccoPlant3Top");
    }

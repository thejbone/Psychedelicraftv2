...
import com.chillaxmc.psychedelicraftv2.PSMultiBlockHelper;
        ...
        if (tileEntity instanceof TileEntityMashTub)
        {
            if (!world.isRemote)
            {
                ...
                if (tileEntityMashTub.solidContents != null)
                {
                    ...
                    player.openGui(Psychedelicraftv2.instance, PSGuiHandler.woodenVatContainerID, world, tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
            }

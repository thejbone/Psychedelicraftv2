...
public class BlockCoffea extends Block implements IGrowable, IvTilledFieldPlant
{
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        for (int i = 1; i < 8; i++)
        {
            bottomIcons[i] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "coffea" + i);
        }

        for (int i = 0; i < 4; i++)
        {
            topIcons[i] = par1IconRegister.registerIcon(Psychedelicraftv2.modBase + "coffeaTop" + i);
        }
    }

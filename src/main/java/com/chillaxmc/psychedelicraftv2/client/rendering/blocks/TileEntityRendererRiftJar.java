...
import com.chillaxmc.psychedelicraftv2.blocks.TileEntityRiftJar;
...
public class TileEntityRendererRiftJar extends TileEntitySpecialRenderer
{
    ...
    public TileEntityRendererRiftJar()
    {
        ...
        texture = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "riftJar.png");
        crackedTexture = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "riftJarCracked.png");

        zeroScreenTexture = new ResourceLocation[8];
        for (int i = 0; i < zeroScreenTexture.length; i++)
        {
            zeroScreenTexture[i] = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "zeroScreen" + i + ".png");
        }

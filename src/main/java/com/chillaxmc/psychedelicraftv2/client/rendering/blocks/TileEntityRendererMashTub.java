...
import com.chillaxmc.psychedelicraftv2.blocks.TileEntityMashTub;
...
{
    public static IModelCustom modelWoodenVat = AdvancedModelLoader.loadModel(new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathModels + "woodenVat.obj"));
    public static ResourceLocation textureMashTub = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "woodenVat.png");

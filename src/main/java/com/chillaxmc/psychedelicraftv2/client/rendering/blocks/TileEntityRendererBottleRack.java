...
import com.chillaxmc.psychedelicraftv2.blocks.TileEntityBottleRack;
import com.chillaxmc.psychedelicraftv2.items.ItemBottle;
...
{
    public static IModelCustom modelBottleRack = AdvancedModelLoader.loadModel(new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathModels + "wineRack.obj"));
    ...
    public TileEntityRendererBottleRack()
    {
        ...
        texture = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "wineRack.png");
    }

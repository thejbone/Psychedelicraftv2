...
import com.chillaxmc.psychedelicraftv2.entities.drugs.DrugHallucination;
...
public class DrugRenderer implements IDrugRenderer
{
    ...
    public DrugRenderer()
    {
        hurtOverlay = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "hurtOverlay.png");
        ...
        effectLensFlare.sunBlindnessTexture = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "sunBlindness.png");
        ...
        {
            effectLensFlare.sunFlareTextures[i] = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "flare" + i + ".png");
        }
    }

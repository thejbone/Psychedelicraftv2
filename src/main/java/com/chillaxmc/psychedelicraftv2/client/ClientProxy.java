...
package com.chillaxmc.psychedelicraftv2.client;
...
import com.chillaxmc.psychedelicraftv2.client.rendering.DrugRenderer;
import com.chillaxmc.psychedelicraftv2.client.rendering.ItemRendererModelCustom;
import com.chillaxmc.psychedelicraftv2.client.rendering.ItemRendererThatMakesFuckingSense;
import com.chillaxmc.psychedelicraftv2.client.rendering.RenderRealityRift;
import com.chillaxmc.psychedelicraftv2.client.rendering.blocks.*;
...
import com.chillaxmc.psychedelicraftv2.entities.PSEntityList;
import com.chillaxmc.psychedelicraftv2.entities.drugs.DrugFactory;
...
import com.chillaxmc.psychedelicraftv2.events.PSCoreHandlerClient;
...
import static com.chillaxmc.psychedelicraftv2.Psychedelicraftv2.*;
import static com.chillaxmc.psychedelicraftv2.config.PSConfig.*;
...
public class ClientProxy implements PSProxy
{
    ...
    public void preInit()
    {
        Psychedelicraftv2.coreHandlerClient = new PSCoreHandlerClient();
        Psychedelicraftv2.coreHandlerClient.register();
    }

    @Override
    public void registerRenderers()
    {
        Psychedelicraftv2.blockWineGrapeLatticeRenderType = RenderingRegistry.getNextAvailableRenderId();
        RenderingRegistry.registerBlockHandler(Psychedelicraftv2.blockWineGrapeLatticeRenderType, new RenderWineGrapeLattice());
        ...
        if (PSEntityList.villagerDealerProfessionID >= 0)
            VillagerRegistry.instance().registerVillagerSkin(PSEntityList.villagerDealerProfessionID, new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "villagerDealer.png"));

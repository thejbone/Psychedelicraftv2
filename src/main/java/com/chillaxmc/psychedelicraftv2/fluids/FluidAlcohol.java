package com.chillaxmc.psychedelicraftv2.fluids;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import ivorius.ivtoolkit.gui.IntegerRange;
import com.chillaxmc.psychedelicraftv2.Psychedelicraftv2;
import com.chillaxmc.psychedelicraftv2.client.rendering.MCColorHelper;
...
public class FluidAlcohol extends FluidDrug implements FluidFermentable, FluidDistillable
{
    ...
    public FluidAlcohol(String fluidName, int fermentationSteps, double fermentationAlcohol, double distillationAlcohol, double maturationAlcohol, TickInfo tickInfo)
    {
        ...
        setStillIconName(Psychedelicraftv2.modBase + "slurry_still");
        setFlowingIconName(Psychedelicraftv2.modBase + "slurry_flow");
    }

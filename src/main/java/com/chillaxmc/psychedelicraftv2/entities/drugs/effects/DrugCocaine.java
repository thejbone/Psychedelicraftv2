...
public class DrugCocaine extends DrugSimple
{
    ...
    public void update(EntityLivingBase entity, DrugProperties drugProperties)
    {
        ...
        if (getActiveValue() > 0.0)
        {
            ...
            if (!entity.worldObj.isRemote)
            {
                ...
                {
                    DamageSource damageSource = random.nextFloat() < 0.4f ? Psychedelicraftv2.stroke
                            : random.nextFloat() < 0.5f ? Psychedelicraftv2.heartFailure
                            : Psychedelicraftv2.respiratoryFailure;
    ...
    {
        return getActiveValue() > 0.4 ? Psychedelicraftv2.sleepStatusDrugs : null;
    }

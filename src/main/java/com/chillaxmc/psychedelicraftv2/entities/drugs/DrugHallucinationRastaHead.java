...
import com.chillaxmc.psychedelicraftv2.client.rendering.ModelRastaHead;
...
//        this.chatBot = new ChatBotRastahead(playerEntity.getRNG(), playerEntity);
        ...
        rastaHeadTexture = new ResourceLocation(Psychedelicraftv2.MODID, Psychedelicraftv2.filePathTextures + "rastaHeadTexture.png");
    }
